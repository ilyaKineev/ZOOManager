...
-- SELECT ANIMAL.NAME, ANIMAL.KIND_OF_ANIMAL ,PRODUCT.NAME,PRODUCT.TYPE  ,ANIMAL_PRODUCTS.norm,PRODUCT.MEASURE  FROM ANIMAL_PRODUCTS JOIN ANIMAL ON ANIMAL_PRODUCTS.ANIMAL_ID=ANIMAL.ID JOIN PRODUCT ON ANIMAL_PRODUCTS.PRODUCTs_ID=PRODUCT.ID
